...
public class AddressUpdateDto {
    ...
    @NotNull(message = "Address ID is required") // Address ID bo'lishi kerak
    ...
    @Size(max = 20, message = "Apartment can be up to 20 characters") // Kvartira raqami ixtiyoriy, maksimal uzunligi 20 belgigacha
